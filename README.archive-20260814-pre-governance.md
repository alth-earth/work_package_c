...
> **文档治理归档声明**
>
> - 文件角色：工作包 C 治理前的项目入口与快速开始说明。
> - 改造时间：2026-08-14（Asia/Shanghai）。
> - 现行去向：现行入口仍为 `README.md`，详细交接入口为 `work_package_c_handoff.md`。
> - 改造原因：原入口同时承担状态、冲刺计划和继续开发指南职责，且引用已归档的综合指南。
> - 完整性：下方标记之后为归档前原正文，逐字保留；归档前 SHA-256 为 `24373548daa3c4618213e7d8507ce95998c60470b540cf101475eb892ef4feac`。
>
> 归档正文中的链接与状态按历史快照保留，不作为现行导航或现状依据。
>
