...
> **文档治理归档声明**
>
> - 文件角色：工作包 C 0.4.0 治理前的 C→D v3/v2 合同说明。
> - 改造时间：2026-08-14（Asia/Shanghai）。
> - 现行去向：同路径 `CD_CONTRACT.md` 继续作为 C→D 合同说明。
> - 改造原因：保留稳定合同语义，移除不应由长期合同承担的 Day 7 日历职责。
> - 完整性：下方标记之后为归档前原正文，逐字保留；归档前 SHA-256 为 `f8e2742d77a2cc50842907c8179867d6b8254cdf28fd5d6be1a5ed634c53969b`。
>
> 归档正文的合同内容仍可追溯，但现行解读以新文件和 Schema/Python 真源为准。
>
